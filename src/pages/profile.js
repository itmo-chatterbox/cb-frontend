...
import {editStatus, getUserInfo, noPhotoURL, userCurrentInfo} from '../utils/users';
    ...
    useEffect(() => {
        ...
        if (pageId) {
            getUserInfo(pageId).then(res => {
                ...
                setPhoto(BASE_URL + res?.photo_url || noPhotoURL);
